...
export const ja: Catalogue = {
  ...
  "run.back": "最初に戻る",
  "run.checkingVoice": "声を確認しています",
  "run.noSpeechTitle": "誰も話していないようです",
  "run.noSpeechBody":
    "この録音からは声が見つからなかったため、文字起こしは行いませんでした。音声モデルはどんな音にも何かを書き出すため、無音や保留音、環境音だけの録音からは、誰も言っていない文が並んで返ってきます。実際に話していた場合は（とても小さい声やこもった声は見逃すことがあります）、それでも文字起こしできます。",
  "run.transcribeAnyway": "それでも文字起こしする",
  "run.cancel": "キャンセル",
