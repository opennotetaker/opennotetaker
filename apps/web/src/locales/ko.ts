...
export const ko: Catalogue = {
  ...
  "run.back": "처음으로",
  "run.checkingVoice": "목소리를 확인하는 중",
  "run.noSpeechTitle": "아무도 말하고 있지 않은 것 같습니다",
  "run.noSpeechBody":
    "이 녹음에서 목소리를 찾지 못해 받아쓰지 않았습니다. 음성 모델은 어떤 소리에든 무언가를 적어 내기 때문에, 무음이나 대기 음악, 배경 소음만 있는 녹음은 아무도 하지 않은 말로 가득 차게 됩니다. 실제로 누군가 말하고 있었다면(아주 작거나 먹먹한 소리는 놓칠 수 있습니다) 그래도 받아쓸 수 있습니다.",
  "run.transcribeAnyway": "그래도 받아쓰기",
  "run.cancel": "취소",
